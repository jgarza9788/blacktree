...
def get_tree(path,sort_all=False):
...
def tree_item_count(tree):
    return len(re.findall('name',str(tree)))


if __name__ == '__main__':
    import pprint
    pprint.pprint(get_tree(r'C:\Users\JGarza\Desktop'), sort_dicts=False)

    t = get_tree(r'C:\Users\JGarza\Desktop')
    print(tree_item_count(t))
